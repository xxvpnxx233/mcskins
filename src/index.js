...
<head>
  ...
  <style>
    ...
    .hint{color:#94a3b8;font-size:14px;line-height:1.7}.err{color:#fecaca}.ok{color:#bbf7d0}code{color:#fde68a}
  </style>
</head>
<body>
  <div class="card">
    <h1>MC APK \u81ea\u52a8\u6539\u5305\u5de5\u5177</h1>
    <p class="hint">\u4e0a\u4f20 APK\u3001custom \u76ae\u80a4\u5305\u3001persona \u76ae\u80a4\u5305\u3002\u7a0b\u5e8f\u4f1a\u628a\u4e24\u4e2a\u76ae\u80a4\u5305\u5206\u522b\u5bfc\u5165 APK \u5185\u7b2c\u4e00\u4e2a\u5339\u914d\u5230\u7684 <code>*/skin_packs/custom/</code> \u548c <code>*/skin_packs/persona/</code>\uff0c\u5e76\u628a\u5305\u540d\u6539\u6210 <code>com.mojang.xxvpnxx</code>\uff0c\u7136\u540e\u91cd\u65b0\u6253\u5305\u5e76\u7b7e\u540d\u3002</p>
    <form id="f">
...
function patchPackageName(apkZip, newPackageName) {
  ...
  if (!manifest) throw new Error("APK \u5185\u6ca1\u6709 AndroidManifest.xml");
...
function patchBinaryXmlStringPool(axml, newPackageName) {
  ...
  if (rd16(dv, 0) !== 0x0003) throw new Error("AndroidManifest.xml \u4e0d\u662f\u6709\u6548 binary XML");
  ...
  while (off + 8 <= bytes.length) {
    ...
    if (type === 0x0001) {
      ...
      if (pkgIndex < 0) throw new Error("\u6ca1\u6709\u5728 AndroidManifest.xml \u5b57\u7b26\u4e32\u6c60\u4e2d\u627e\u5230\u539f\u5305\u540d\uff0c\u65e0\u6cd5\u6539\u5305\u540d");
  ...
  throw new Error("\u6ca1\u6709\u5728 AndroidManifest.xml \u5b57\u7b26\u4e32\u6c60\u4e2d\u627e\u5230\u539f\u5305\u540d\uff0c\u65e0\u6cd5\u6539\u5305\u540d");
}
